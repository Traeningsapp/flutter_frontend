...
extension StringCasingExtension on String {
  String replaceDashesWithSpaces() => replaceAll('-', ' ');
  String replaceUnderscoresWithSpaces() => replaceAll('_', ' ');
  String removeSquareBrackets() => replaceAll(RegExp(r'[\[\]]+'), '');
  String replaceDashesWithUnderscores() => replaceAll('-', '_');
  String toTitleCase() {
